...
class DiscreteDirector(BaseDirector):
    ...
    def process_frame(
        ...
        # Load config values
        horizontal_field_of_view = ROBOT_CONFIGS[hostname].horizontal_field_of_view
        vertical_field_of_view = ROBOT_CONFIGS[hostname].vertical_field_of_view
        confirmation_delay = ROBOT_CONFIGS[hostname].confirmation_delay
        command_delay = ROBOT_CONFIGS[hostname].command_delay
